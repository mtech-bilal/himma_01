...
<template>
  <div class="d-lg-block d-none">
    <!-- <VBtn icon class="app-customizer-toggler rounded-s-pill rounded-0" style="z-index: 1001;"
    ...
    <VNavigationDrawer v-model="isNavDrawerOpen" data-allow-mismatch temporary touchless border="none" location="end"
      width="400" :scrim="false" class="app-customizer">
      <!-- 👉 Header -->
      <div class="customizer-heading d-flex align-center justify-space-between">
        ...
        <div class="d-flex align-center">
          <VBtn icon variant="text" color="medium-emphasis" @click="resetCustomizer">
            <VBadge v-show="isCookieHasAnyValue" dot color="error" offset-x="-30" offset-y="-15" />

            <VIcon size="24" icon="ri-refresh-line" />
          </VBtn>

          <VBtn icon variant="text" color="medium-emphasis" @click="isNavDrawerOpen = false">
          ...
          <div class="d-flex flex-column gap-2">
            ...
            <div class="d-flex app-customizer-primary-colors" style="column-gap: 0.75rem; margin-block-start: 2px;">
              ...
              padding-inline: 0.625rem;" class="primary-color-wrapper cursor-pointer"
                ...
                <div style="border-radius: 0.5rem;block-size: 2.125rem; inline-size: 1.9375rem;"
              ...
              padding-inline: 0.625rem;"
                ...
                <VBtn icon size="small"
                  ...
                  variant="flat" style="border-radius: 0.5rem;">

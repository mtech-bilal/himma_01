      ...
      <VTimeline side="end" align="start" line-inset="9" truncate-line="start" density="compact">
        ...
        <VTimelineItem dot-color="primary" size="x-small">
          ...
          <div class="app-timeline-text mt-1">
            Invoices have been paid to the Himma
          </div>
          ...
          <div class="d-flex justify-space-between align-center flex-wrap">
            ...
            <div class="d-flex align-center my-2">
              ...
              <div class="d-flex flex-column">
                ...
                <span class="text-sm">CEO of Himma</span>
              </div>
            </div>
          </div>
        </VTimelineItem>
        ...
        <VTimelineItem size="x-small" dot-color="info">
          ...
          <div class="v-avatar-group demo-avatar-group">
            ...
            <VAvatar :size="40" :color="$vuetify.theme.current.dark ? '#383B55' : '#F0EFF0'">
              +3
            </VAvatar>
          </div>
        </VTimelineItem>

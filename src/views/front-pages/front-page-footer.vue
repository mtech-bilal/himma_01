        ...
        <VRow>
          ...
          <VCol cols="12" md="5">
            <div class="footer-form">
              ...
              <div class="text-body-1 footer-text mb-6">
                Most Powerful & Comprehensive <span class="text-high-emphasis">🤩</span> Vuejs Admin Template with
                Elegant Material Design & Unique Layouts.
              </div>
              <VForm class="subscribe-form d-flex align-center gap-4">
                <VTextField label="Subscribe to newsletter" placeholder="john@email.com" theme="dark" density="compact"
                  class="footer-text" />
                <VBtn size="large">
                  Subscribe
                </VBtn>
            ...
            <div class="footer-links">
              ...
              <ul style="list-style: none;">
                <li v-for="(item, index) in menus" :key="index" class="mb-4">
                  <RouterLink class="text-body-1 footer-text text-no-wrap" :to="item.to">
                    <div class="d-flex align-center">
                      <div>
                        {{ item.name }}
                      </div>
                      <template v-if="item.isNew">
                        <VChip color="primary" variant="elevated" size="small" class="ms-2">
                          New
                        </VChip>
                      </template>
                    </div>
          ...
          <VCol md="2" sm="4" xs="6">
            <div class="footer-links">
              ...
              <ul>
                <li v-for="(item, index) in ['Page Builder', 'Admin Dashboards', 'UI Kits', 'Illustrations']"
                  :key="index" class="mb-4 text-body-1" style="list-style: none;">
          ...
          <VCol cols="12" md="3" sm="4">
            <div>
              ...
              <div>
                ...
                ]" :key="index" color="#211B2C" height="56" size="large" class="mb-4 d-block">
                  <template #default>
      ...
      <VContainer>
        <div class="d-flex justify-space-between flex-wrap gap-y-4">
          <!-- <span class="d-flex align-center text-body-2 footer-heading font-weight-regular">
            ...
            Made with <span>
              <VIcon icon="ri-heart-fill" color="#FF4D49" />
            </span> by <a href="https://pixinvent.com/" target="_blank" rel="noopener noreferrer"
              class="ms-1 footer-heading font-weight-regular"
              style="color: rgba(255, 255, 255, var(--v-high-emphasis-opacity));">Pixinvent</a>
          </span> -->
          <div class="d-flex gap-x-1">
            <template v-for="(item, index) in [
              ...
              <IconBtn :href="item.href" size="x-small" target="_blank" color="#fff" rel="noopener noreferrer">

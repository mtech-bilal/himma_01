...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'loan-request': RouteRecordInfo<'loan-request', '/loan-request', Record<never, never>, Record<never, never>>,
    'loan-request-index copy': RouteRecordInfo<'loan-request-index copy', '/loan-request/index copy', Record<never, never>, Record<never, never>>,
